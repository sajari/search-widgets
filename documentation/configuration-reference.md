...
Widgets are discrete blocks of content on a page or the header of an application. All widgets that are created using [Sajari React SDK](https://react.docs.sajari.com/) share general configuration properties:

| Name                   | Type                                                                   | Default | Description                                                                                                                                            |
| ---------------------- | ---------------------------------------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `pipeline`             | `string (required)`                                                    | `_`     | The pipeline configuration.                                                                                                                            |
| `account`              | `string (required)`                                                    | `_`     | The account configuration.                                                                                                                             |
| `collection`           | `string (required)`                                                    | `_`     | The collection configuration.                                                                                                                          |
...
| `mode`                    | `'standard'` \| `'typeahead'` \| `'suggestions'` \| `'results'` \| `'instant'` | `'results'`                                                           | The mode of the input. For details, see [Input props](https://react.docs.sajari.com/search-ui/input#props). |
...
The search input widget enables users to search for content on your website. Once you add the snippet on a page, a text box for entering search keywords is displayed. The following options can be configured when creating the Search Input Widget.

| Name       | Type                                                                           | Default                                | Description                                                                                                                                                                |
| ---------- | ------------------------------------------------------------------------------ | -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `mode`     | `'standard'` \| `'typeahead'` \| `'suggestions'` \| `'results'` \| `'instant'` | `'suggestions'`                        | The mode of the input. For details, see [Input props](https://react.docs.sajari.com/search-ui/input#props).                                                                |
