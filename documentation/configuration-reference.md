...
| `summary`        | `SummaryProps`                                                 | `_`                                                                                          | Options of Summary component used to display the number of results and the latency from a search query. See [Summary props](https://react.docs.search.io/search-ui/summary)                                    |
| `results`        | [`ResultsOptions`](#resultsoptions)                            | `{imageAspectRatio: {grid: 1, list: 1}, imageObjectFit: {grid: 'cover', list: 'container'}}` | Options of Results component displaying result response from a search query.                                                                                                                                   |
...
The `ResultsOptions` composes [Results props](https://react.docs.sajari.com/search-ui/results#props) and the following options:

| Name             | Type                 | Default  | Description                                      |
| ---------------- | -------------------- | -------- | ------------------------------------------------ |
| `viewType`       | `'list'` \| `'grid'` | `'grid'` | Control the viewing modes of results on desktop. |
| `mobileViewType` | `'list'` \| `'grid'` | `'list'` | Control the viewing modes of results on mobile.  |
