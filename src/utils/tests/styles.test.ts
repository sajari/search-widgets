...
describe('parseBreakpoints function should work correctly', () => {
  test.each([
    [
      639,
      {
  ...
  ])('parseBreakpoints($o)', (input, expected) => {
    expect(parseBreakpoints(input)).toStrictEqual(expected);
  });
});
...
describe('parseRatio function should work correctly', () => {
  test.each([
    ['1:2', 1],
    ['3:1', 3],
    ['4:5', 4],
