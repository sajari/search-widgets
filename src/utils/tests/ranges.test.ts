...
describe('isRange function should work correctly', () => {
  test.each([
    [undefined, false],
    [null, false],
    [12, false],
...
describe('rangeToParam function should work correctly', () => {
...
describe('paramToRange function should works correctly', () => {
  test.each([
    ['1:2', [1, 2]],
    ['3:5', [3, 5]],
    ['99:42', [99, 42]],
